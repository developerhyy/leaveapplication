...
//获取年月日 如2017-11-12
    ...
    function addOperation(){
    	...
    	operation.operation_name="备份操作日志";
    	operation.staff_id=1;
        operation.corp_id=0;
        operation.operate_time="";
    	operation.operate_content="备份了"+$("#begin_time").val()+"到"+$("#end_time").val()+"时间段内的操作日志";
        operation.module="日志管理模块";
        operation.child_module="操作日志管理模块";
        operation.operation_obj="操作日志";
        operation.user_id=0;
...
<body class="mainbody">
	<form id="form1" method="post">
		<script type="text/javascript">
			...
			<!-- 导航栏 -->
	<!-- 		<div class="location">
				<a href="javascript:;" class="home"><i></i><span>操作日志</span>
				</a>
			</div> -->
			...
			<div class="toolbar-wrap">
				...
				<div id="floatHead" class="toolbar">
					<div class="r-list" style="float: none">
						...
						<input type="text" name="module" id="module" class="operation_date" placeholder="模块名称">
						<!-- <span class="child_module">子模块:</span> -->
						<input type="text" name="childModule" id="childModule" class="operation_date" placeholder="子模块名称">
						...
						<input name="end_time" type="text" id="end_time" class="operation_date"
							...
							datatype="*1-50" errormsg="请选择正确的日期" sucmsg=" " nullmsg=" "
							placeholder="结束日期"  />
						<a id="lbtnSearch" class="query" onclick="queryGrid();">查询</a>
						<a id="lbtnSearch" class="reset" onclick="doReset();"><span>重 置</span></a>
						<a id="lbtnSearch" class="copy" onclick="doCopy();"><span>备 份</span></a>
					</div>
